...
###2/9/2022 Suggestion from T.Fagin- switch from clipped bounding box to
### buffered box around distribution: how many km/cells? or % of distribution
### 3 pixels ~ 18 km
### 10% length/widhth to a max of 50km
