...
veg_rasters<- veg_rasters[c(1,2,12:16,18, 23)]
...
write.csv(trans_data, paste0("I:/projects/CEMML_DOD/CEMML_HCCVI/data_products/", type, "_Region_Score_Card_6_24_EVT.csv"))
